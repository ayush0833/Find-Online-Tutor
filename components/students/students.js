      ...
      {users.map((user,index)=>(
          ...
          <div className='details' key={index}>
            <table >
              ...
              <tr><td colSpan={3}><button  onClick={()=>reqAdd(index)} className='btn btn-success'>Apply</button>
              <Link to={`/teacherData/${user._id}`} className='btn btn-success ' style={{marginLeft:"2%"}}>Show Details</Link>
              </td></tr>
            </table>
